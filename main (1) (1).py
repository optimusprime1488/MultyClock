...
ah_plus =Tab(int((w/5)/2.5),int(h/8.1), int(w*0.35) , int(h*0.25),(255,255,255),'+',(0,0,0),43,4,-15)
ah_minus=Tab(int((w/5)/2.5),int(h/8), int(w*0.35) , int(h*0.78),(255,255,255),'-',(0,0,0),50,7,-21)
am_plus=Tab(int((w/5)/2.5),int(h/8.1), int(w*0.63) , int(h*0.25),(255,255,255),'+',(0,0,0),43,4,-15)
am_minus=Tab(int((w/5)/2.5),int(h/8), int(w*0.63) , int(h*0.78),(255,255,255),'-',(0,0,0),50,7,-21)
...
a_rechose = Tab(int((w/4)),int(h/8), int(w*0.73) , int(h*0.5),(255,255,255),'Поменять',(0,0,0),19,10,0)
...
while  run:
    ...
    if mode == 'таймер':
        ...
        if a_stop.rect.collidepoint(x,y) and stop == True:
            stop = True
            sound2.stop()
            x,y = -1,-1

        if a_rechose.rect.collidepoint(x,y) and stop == False:
            stop = True
